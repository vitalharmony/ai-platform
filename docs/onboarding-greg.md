...
Read `../3-lane-protocol.md` and `../ai-platform.md` first. This file is
**generic/incomplete** — the Ke'nekted repo's actual location, stack, and
tooling are still `TBD` in the project registry (`ai-platform.md` §7), and
nobody drafting this platform has visibility into that repo yet. Treat
everything below as a placeholder to fill in once that access exists, not as
confirmed fact.
...
## What's Still Unknown — Fill In Before This Doc Is Real

- [ ] Ke'nekted repo URL and default branch
...
## Setup Steps (Generic — Adjust Once the Above Is Known)

1. `git clone https://github.com/vitalharmony/ai-platform.git ~/ai-platform/`
2. Clone the Ke'nekted repo (URL TBD).
